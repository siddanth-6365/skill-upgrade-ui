        ...
        <>
            ...
            <div className="mt-8 p-4 flex justify-center items-center">
                <div className='md:w-[70%] w-full'>
                    <h2 className="md:text-4xl text-2xl text-center font-semibold mb-4">Mastering {data.title} Magic</h2>
            ...
            <div className="md:mt-6 mt-4 px-6 flex flex-col justify-center items-center   w-full">
                ...
                <div >
                    <Accordion type="single" collapsible className="w-full md:w-[70%] bg-gray-200 p-4">
                        {data && data.faq && data.faq.map((faqItem) => (
                            <AccordionItem value={faqItem.id} key={faqItem.id}>
