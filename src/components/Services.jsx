...
function ServiceItem({ title, description, icon, color }) {
  ...
  return (
    <div className="flex flex-col items-center mb-4 md:mb-0">
      <div
        className={`border-dotted border-${color} border-2 w-32 p-8 flex justify-center items-center rounded-full mb-2 md:mb-4`}
      >
        <div
          className={`w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition-colors duration-300 ${isHovered ? "bg-gray-200" : `bg-${color}`}`}
  ...
  const services = [
    {
            ...
            color:"#146ef7",
            icon: (
              <svg stroke="currentColor" fill="#146ef7" stroke-width="0" viewBox="0 0 448 512" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            description:
             ...
             color:"#1ea528",
              icon: (
              <svg stroke="currentColor" fill="#1ea528" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#bb4846",
            icon: (
              <svg stroke="currentColor" fill="#bb4846" stroke-width="0" viewBox="0 0 24 24" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
                <g>
          ...
          },
          {
            ...
            color:"#fac210",
            icon: (
              <svg stroke="currentColor" fill="#fac210" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#2b3b9a",
            icon: (
              <svg stroke="currentColor" fill="#2b3b9a" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#775e75",
            icon: (
              <svg stroke="currentColor" fill="#775e75" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#745c65",
            icon: (
              <svg stroke="currentColor" fill="#745c65" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#6c6087",
            icon: (
              <svg stroke="currentColor" fill="#6c6087" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#d2373e",
            icon: (
              <svg stroke="currentColor" fill="#d2373e" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          },
          {
            ...
            color:"#a34e36",
            icon: (
              <svg stroke="currentColor" fill="#a34e36" stroke-width="0" viewBox="0 0 16 16" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
