...
function HeroSection() {
  return (
    <section class="px-2 py-32 bg-white md:px-0 h-screen flex justify-center items-center">
    <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
      <div class="flex flex-wrap items-center sm:-mx-3">
        <div class="w-full md:w-1/2 md:px-3">
          <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
        <span class="block xl:inline">Useful Courses to</span>
        <span class="block text-indigo-600 xl:inline">Help You Grow Faster.</span>
      </h1>
            <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
              Provides you with latest online courses and material that helps your knowledge growing..
            </p>
        ...
        <div class="w-full  md:w-1/2">
          <div class="w-full  overflow-hidden rounded-md shadow-xl sm:rounded-xl">
            ...
            {/* <img style={s1 } src={require("./Online learning-amico.png")} /> */}
          </div>
        </div>
      </div>
    </div>
